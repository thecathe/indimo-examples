...
> This is a *simplified* version of the [timed-rates-based demo](../rates-timed/README.md), where the Producer/Consumer are completely *time unaware*.
